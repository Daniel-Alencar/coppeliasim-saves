...
Fluxo de dados:
    ...
    turtle_teleop_key --(/turtle1/cmd_vel)--> esta ponte --(ZeroMQ)--> CoppeliaSim
...
class CoppeliaBridge(Node):
    ...
    def __init__(self):
        ...
        # --- Comunicação ROS -------------------------------------------------
        # Assinatura: cada Twist publicado em /turtle1/cmd_vel chama
        # cmd_vel_callback. O 10 é a profundidade da fila de mensagens (QoS).
    ...
    def find(self, path):
        ...
        try:
            ...
            raise SystemExit(
                ...
                '  /usr/bin/python3 teleoperation_with_ros2.py --ros-args -p robot:=/meuRobo'
            )
    ...
    def step(self):
        ...
        # O turtle_teleop_key só publica quando uma tecla chega, então soltar
